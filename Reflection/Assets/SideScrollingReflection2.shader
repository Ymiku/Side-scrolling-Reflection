Shader "Unlit/SideScrollingReflection2"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			v2f vert (appdata v)
			{
				...
				half doffset = 4*(sin(worldPos.x/5)+1);
				half realDis = _backgroundDis-doffset;
				//realDis = 
				half dis = worldPos.z - realDis;
				...
				//o.reflectUV.x -= viewDir.x*0.01*o.reflectUV.y;
				//half tempY = o.reflectUV.y;
				//o.reflectUV.y += abs(o.reflectUV.x-0.5)*tempY*2;
